# This code used PSV for smoothness check
import sys
import csv
...
R.<u> = PolynomialRing(RR)

#-----------------------------------------
# Helper Functions:
#-----------------------------------------
def symmetric():
    a_00 = randint(1,limit)
    a_01 = randint(1,limit)
    a_02 = randint(1,limit)
    a_11 = randint(1,limit)
    a_12 = randint(1,limit)
    a_22 = randint(1,limit)
